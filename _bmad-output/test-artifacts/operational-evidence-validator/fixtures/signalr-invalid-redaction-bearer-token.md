# SignalR Operational Evidence Fixture - Bearer Token
...
evidence_run_id: dw4-signalr-bearer-001
...
reliability_control: same-run reliability control recorded pass
...
Reliability control is present.

## Redaction

Unsafe raw SignalR join trace contains Bearer eyJhbGciOiJIUzI1NiJ9.synthetic.signature.

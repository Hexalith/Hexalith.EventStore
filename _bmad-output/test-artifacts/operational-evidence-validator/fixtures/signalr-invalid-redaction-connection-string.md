# SignalR Operational Evidence Fixture - Connection String
...
evidence_run_id: dw4-signalr-connection-string-001
...
Unsafe raw diagnostic: Server=example;Password=secret;

...
| Problem-detail/status parsing and raw-body redaction | `dotnet test tests/Hexalith.EventStore.Admin.UI.Tests/Hexalith.EventStore.Admin.UI.Tests.csproj --no-restore --filter "AdminDeadLetterApiClientErrorTests"` | 6/6 pass |

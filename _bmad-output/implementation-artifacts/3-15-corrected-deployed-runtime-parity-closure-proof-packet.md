...
`sha256:c98fdef266671a8b35e05c64b95eed275cb506e4368e28ab6957aa7750640df3`
was re-minted on 2026-09-26 after curl configuration isolation changed the bound capture producer.
The three receipts for prior subject `7d64f87e...` are superseded; the retained verifier exits 1
...
`acceptances/c98fdef266671a8b35e05c64b95eed275cb506e4368e28ab6957aa7750640df3/`;
...
No receipt binds current subject `c98fdef2...`. The three prior receipts bind `7d64f87e...`
...
Reassembly deterministically reproduces subject `c98fdef2...` and runs the pinned verifier over its
...
regressions passed **2108/2108**, with zero failures, skips, or unrun tests. Current focused
validation follows this 2026-09-26 re-mint; the Story 3.14 predecessor packet remains unchanged.

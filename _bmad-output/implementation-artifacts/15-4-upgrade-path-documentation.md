...
- [x] Task 3: Update FR traceability (AC: #6)
  ...
  - [x] 3.2 Update gap summary counts (15 gaps → 14)
  - [x] 3.3 Update coverage percentage (76% → 78%)
...
- `docs/concepts/event-versioning.md` — event *payload* schema evolution strategies
- This page (`upgrade-path.md`) — the *general procedure* for upgrading between Hexalith versions (package-level, not event-level)
...
- Updated docs/fr-traceability.md: FR52 GAP → COVERED, gap count 15 → 14, coverage 76% → 78%, removed FR52 from gap analysis table

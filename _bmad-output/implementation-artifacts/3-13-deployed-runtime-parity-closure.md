...
- 2026-08-12 thirteenth review pass closed every remaining review patch, rebound the complete
  ...
  1254/1275; all 21 failures are the unrelated OQ8 verifier's contradictory requirement for the
  orphan Story 4.8 status row that this story's governing spec explicitly removes. AC2/AC4 and
  0/3 acceptances remain open.

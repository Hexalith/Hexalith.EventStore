...
- Status set to `in-progress` after the 2026-08-12 chunk-2/3 code review. Five high-severity
  patches were applied; 20 medium patch findings remain as action items. The fail-closed packet
  still has external evidence blockers; AC2/AC4 remain open with 0/3 acceptances.

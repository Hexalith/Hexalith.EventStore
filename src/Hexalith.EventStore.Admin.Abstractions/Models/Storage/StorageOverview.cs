...
/// <param name="IndexStatus">The data-quality state of the operational storage index.</param>
public record StorageOverview(
    long TotalEventCount,
    long? TotalSizeBytes,
    IReadOnlyList<TenantStorageInfo> TenantBreakdown,
    long? TotalStreamCount = null,
    StorageIndexStatus IndexStatus = StorageIndexStatus.Populated) {

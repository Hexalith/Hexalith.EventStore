...
public static class EventStoreActivitySource {
    ...
    /// <summary>Event drain recovery stage (Story 4.2).</summary>
    public const string EventsDrain = "EventStore.Events.Drain";

    /// <summary>Dead-letter publication stage.</summary>
    ...
    /// <summary>Tag key for exception type used by dead-letter routing.</summary>
    public const string TagExceptionType = "eventstore.exception_type";

    /// <summary>Tag key for failure stage used by dead-letter routing.</summary>
    public const string TagFailureStage = "eventstore.failure_stage";

    /// <summary>Tag key for dead-letter topic.</summary>

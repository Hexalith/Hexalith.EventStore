...
internal static class RestApiControllerEmitter
{
    ...
    private static void AppendQueryAction(StringBuilder builder, RestApiOptions options, RestApiMessageDescriptor message)
    {
        ...
        builder.AppendLine("                .ConfigureAwait(false);");
        builder.AppendLine();
        builder.AppendLine("            string? __hexalithETag = __hexalithResult.ETag ?? __hexalithResult.Metadata?.ETag;");
    ...
    private static void AppendHelpers(StringBuilder builder, RestApiOptions options)
    {
        ...
        builder.AppendLine("        }");
        builder.AppendLine();
        builder.AppendLine("        if (TryGetBoundedHeaderValue(metadata.ProjectionVersion, out string? projectionVersion))");
        builder.AppendLine("        {");
        ...
        builder.AppendLine("        }");
        builder.AppendLine();
        builder.AppendLine("        if (metadata.IsStale is not null)");
        builder.AppendLine("        {");

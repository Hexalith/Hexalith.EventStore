...
public static class SnapshotDeletePolicyCommand {
    ...
    public static Command Create(GlobalOptionsBinding binding) {
        ...
        Command command = new("delete-policy", "Delete a snapshot policy for an aggregate type");
        ...
        command.SetAction(async (parseResult, cancellationToken) => {
            ...
            return await ExecuteAsync(options, tenantId, domain, aggregateType, cancellationToken).ConfigureAwait(false);
        });
        return command;
    }

...
internal static class Dw4FixtureCatalog {
    ...
    public static readonly IReadOnlyList<FixtureExpectation> All = [
        ...
        new("query-valid-linked-control-run.md",
            SchemaSlot: Dw4RuleVocabulary.SchemaQueryV1,
            Verdict.Pass,
            ExpectedRuleIds: new HashSet<string>(StringComparer.Ordinal),
            Notes: "DW9 valid query/v1 evidence where controls reference declared linked control-run ids."),
        ...
        new("query-invalid-control-linkage-missing.md",
            SchemaSlot: Dw4RuleVocabulary.SchemaQueryV1,
            Verdict.Fail,
            ExpectedRuleIds: new HashSet<string>(StringComparer.Ordinal) {
                Dw4RuleVocabulary.ControlLinkageMissing,
            },
            Notes: "DW9 false-positive control is present but has no explicit same-run or linked-control-run reference."),
        new("query-invalid-control-linkage-unrelated.md",
            SchemaSlot: Dw4RuleVocabulary.SchemaQueryV1,
            Verdict.Fail,
            ExpectedRuleIds: new HashSet<string>(StringComparer.Ordinal) {
                Dw4RuleVocabulary.ControlLinkageUnrelated,
            },
            Notes: "DW9 false-positive control references a control run not declared by linked_control_run_ids."),
        ...
        new("signalr-valid-linked-control-run.md",
            SchemaSlot: Dw4RuleVocabulary.SchemaSignalrV1,
            Verdict.Pass,
            ExpectedRuleIds: new HashSet<string>(StringComparer.Ordinal),
            Notes: "DW9 valid signalr/v1 evidence where reliability_control references a declared linked control-run id."),
        ...
        new("signalr-invalid-control-linkage-missing.md",
            SchemaSlot: Dw4RuleVocabulary.SchemaSignalrV1,
            Verdict.Fail,
            ExpectedRuleIds: new HashSet<string>(StringComparer.Ordinal) {
                Dw4RuleVocabulary.ControlLinkageMissing,
            },
            Notes: "DW9 reliability control is present but has no explicit same-run or linked-control-run reference."),
        new("signalr-invalid-control-linkage-unrelated.md",
            SchemaSlot: Dw4RuleVocabulary.SchemaSignalrV1,
            Verdict.Fail,
            ExpectedRuleIds: new HashSet<string>(StringComparer.Ordinal) {
                Dw4RuleVocabulary.ControlLinkageUnrelated,
            },
            Notes: "DW9 reliability control references a control run not declared by linked_control_run_ids."),

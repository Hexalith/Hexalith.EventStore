...
public sealed class SampleApiStructuralTests
{
    ...
    public void SampleApiSource_HasNoRazorOrUiConcerns()
    {
        ...
        string sourceText = ReadSampleApiSourceAndProject();
    ...
    public void CounterRestController_IsOnlyGeneratedControllerAndUsesGatewayBoundary()
    {
        ...
        controller.GetMethods(BindingFlags.Instance | BindingFlags.Public | BindingFlags.DeclaredOnly)
            ...
            .ShouldBe(
                [
                    "GetCounterStatusQueryQueryAsync",
    ...
    private static string ReadSampleApiSourceAndProject()
        => string.Join(
            Environment.NewLine,
            Directory.EnumerateFiles(SampleApiRoot(), "*.*", SearchOption.AllDirectories)

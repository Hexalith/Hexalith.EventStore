...
public class TenantValidatorTests
{
    ...
    {
        // Act
        var ex = Should.Throw<TenantMismatchException>(
            () => _validator.Validate("tenant-b", "tenant-a:orders:order-42"));
    ...
    [Fact]
    public void Validate_NullCommandTenant_ThrowsArgumentException()
    {
    ...
    [Fact]
    public void Validate_NullActorId_ThrowsArgumentException()
    {
        Should.Throw<ArgumentException>(
    ...
    [Fact]
    public void Validate_EmptyCommandTenant_ThrowsArgumentException()
    {
        Should.Throw<ArgumentException>(

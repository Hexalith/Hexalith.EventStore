...
public class EventStoreAuthorizationRegistrationTests {
    ...
    [Fact]
    public void AddEventStore_DefaultAuthorizationOptions_ResolveClaimsTenantValidator() {
    ...
    [Fact]
    public void AddEventStore_DefaultAuthorizationOptions_ResolveClaimsRbacValidator() {
        using ServiceProvider provider = BuildProvider();
        using IServiceScope scope = provider.CreateScope();
    ...
    [Fact]
    public void AddEventStore_ConfiguredTenantActor_ResolvesActorTenantValidator() {
        using ServiceProvider provider = BuildProvider(
    ...
    [Fact]
    public void AddEventStore_ConfiguredRbacActor_ResolvesActorRbacValidator() {
        using ServiceProvider provider = BuildProvider(
            new Dictionary<string, string?> {
    ...
    [Fact]
    public async Task AddEventStore_ConfiguredTenantActor_PassesStartupValidationAsync() {
        using ServiceProvider provider = BuildProvider(
            new Dictionary<string, string?> {
                ["EventStore:Authorization:TenantValidatorActorName"] = "TenantValidatorActor",
            });
    ...
    [Fact]
    public async Task AddEventStore_ConfiguredRbacActor_PassesStartupValidationAsync() {
        using ServiceProvider provider = BuildProvider(
            new Dictionary<string, string?> {
                ["EventStore:Authorization:RbacValidatorActorName"] = "RbacValidatorActor",
            });
    ...
    [Fact]
    public void AddEventStore_ClaimsTenantWithActorRbac_ResolvesMixedConfig() {
        using ServiceProvider provider = BuildProvider(
            new Dictionary<string, string?> {
    ...
    [Fact]
    public void AddEventStore_DefaultConfig_ResolvesAuthorizationBehaviorWithValidators() {
    ...
    [Fact]
    public void AddEventStore_ActorTenantWithClaimsRbac_ResolvesMixedConfig() {
        using ServiceProvider provider = BuildProvider(
            new Dictionary<string, string?> {
                ["EventStore:Authorization:TenantValidatorActorName"] = "TenantValidatorActor",
    ...
    [Fact]
    public async Task AddEventStore_MediatRPipelineOrdering_ExecutesInCorrectOrderAsync() {
        // Arrange

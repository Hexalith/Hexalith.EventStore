...
public class TimelineEntryTypeBadgeTests
{
    ...
    {
        StatusDisplayConfig config = StatusDisplayConfig.FromTimelineEntryType(TimelineEntryType.Command);
    ...
    {
        StatusDisplayConfig config = StatusDisplayConfig.FromTimelineEntryType(TimelineEntryType.Event);
    ...
    {
        StatusDisplayConfig config = StatusDisplayConfig.FromTimelineEntryType(TimelineEntryType.Query);

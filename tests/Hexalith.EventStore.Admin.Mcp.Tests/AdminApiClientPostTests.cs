...
public class AdminApiClientPostTests {
    ...
    public async Task PostAsync_DeserializesAdminOperationResult() {
        ...
        AdminOperationResult? result = await client.PostAsync("/api/v1/admin/test", CancellationToken.None);
    ...
    public async Task PostAsync_ThrowsHttpRequestExceptionOn4xx() {
        ...
        _ = await Should.ThrowAsync<HttpRequestException>(() => client.PostAsync("/api/v1/admin/test", CancellationToken.None));
    }
    ...
    public async Task PostAsyncWithBody_DeserializesAdminOperationResult() {
        ...
        AdminOperationResult? result = await client.PostAsync("/api/v1/admin/test", new { data = "test" }, CancellationToken.None);
    ...
    public async Task PostAsyncWithBody_ThrowsHttpRequestExceptionOn4xx() {
        ...
        _ = await Should.ThrowAsync<HttpRequestException>(() => client.PostAsync("/api/v1/admin/test", new { data = "test" }, CancellationToken.None));
    }

...
public class AdminProjectionsControllerTests {
    ...
    public AdminProjectionsControllerTests() => _sut = new AdminProjectionsController(_queryService, _commandService, NullLogger<AdminProjectionsController>.Instance) {
    ...
    public async Task ListProjections_DelegatesToQueryService() {
        ...
        _ = _queryService.ListProjectionsAsync(Arg.Any<string?>(), Arg.Any<CancellationToken>())
            .Returns(expected);
    ...
    public async Task PauseProjection_DelegatesToCommandService() {
        ...
        _ = _commandService.PauseProjectionAsync("tenant-a", "proj1", Arg.Any<CancellationToken>())
            .Returns(expected);
    ...
    public async Task ResumeProjection_DelegatesToCommandService() {
        ...
        _ = _commandService.ResumeProjectionAsync("tenant-a", "proj1", Arg.Any<CancellationToken>())
            .Returns(expected);
    ...
    public async Task GetProjectionDetail_NullResult_Returns404() {
        _ = _queryService.GetProjectionDetailAsync(Arg.Any<string>(), Arg.Any<string>(), Arg.Any<CancellationToken>())

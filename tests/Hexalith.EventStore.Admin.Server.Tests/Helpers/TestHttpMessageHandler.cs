...
internal sealed class TestHttpMessageHandler : HttpMessageHandler {
    ...
    public TestHttpMessageHandler() => _handler = (_, _) => Task.FromResult(new HttpResponseMessage(HttpStatusCode.OK));
    ...
    /// </summary>
    public void SetupResponse(HttpResponseMessage response) => _handler = (_, _) => Task.FromResult(response);
    ...
    /// </summary>
    public void SetupJsonResponse<T>(T content, HttpStatusCode statusCode = HttpStatusCode.OK) => _handler = (_, _) => Task.FromResult(new HttpResponseMessage(statusCode) {
    ...
    /// </summary>
    public void SetupEmptyResponse(HttpStatusCode statusCode = HttpStatusCode.OK) => _handler = (_, _) => Task.FromResult(new HttpResponseMessage(statusCode) {
    ...
    /// </summary>
    public void SetupNullJsonResponse(HttpStatusCode statusCode = HttpStatusCode.OK) => _handler = (_, _) => Task.FromResult(new HttpResponseMessage(statusCode) {
    ...
    /// </summary>
    public void SetupException(Exception exception) => _handler = (_, _) => throw exception;

    /// <summary>
    /// Configures the handler to return a non-success status code (triggers EnsureSuccessStatusCode failure).
    /// </summary>
    public void SetupErrorResponse(HttpStatusCode statusCode, string? reasonPhrase = null) => _handler = (_, _) => Task.FromResult(new HttpResponseMessage(statusCode) {

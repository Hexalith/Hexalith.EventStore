...
public class DaprActorTypeInfoTests {
    ...
    [InlineData("")]
    [InlineData("   ")]
    public void Constructor_WithInvalidDescription_ThrowsArgumentException(string? description) => Should.Throw<ArgumentException>(() =>
    ...
    [InlineData("")]
    [InlineData("   ")]
    public void Constructor_WithInvalidActorIdFormat_ThrowsArgumentException(string? format) => Should.Throw<ArgumentException>(() =>
                                                                                                         new DaprActorTypeInfo("Type", 0, "Description", format!));
    ...
    [Fact]
    public void Constructor_WithActiveCountBelowNegativeOne_ThrowsArgumentOutOfRange() => Should.Throw<ArgumentOutOfRangeException>(() =>

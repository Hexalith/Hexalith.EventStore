...
public class DaprSidecarInfoTests
{
    ...
    {
        var info = new DaprSidecarInfo("my-app", "1.14.0", 5, 3, 2);
    ...
    public void Constructor_WithInvalidAppId_ThrowsArgumentException(string? appId)
    {
        Should.Throw<ArgumentException>(() =>
            new DaprSidecarInfo(appId!, "1.14.0", 5, 3, 2));
    }
    ...
    {
        Should.Throw<ArgumentException>(() =>
            new DaprSidecarInfo("my-app", runtimeVersion!, 5, 3, 2));
    }

    [Fact]
    public void Constructor_WithZeroCounts_CreatesInstance()
    {
        var info = new DaprSidecarInfo("my-app", "1.14.0", 0, 0, 0);

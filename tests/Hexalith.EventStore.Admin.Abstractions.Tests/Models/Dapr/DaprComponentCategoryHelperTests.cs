...
public class DaprComponentCategoryHelperTests
{
    ...
    public void FromComponentType_WithValidPrefix_ReturnsCorrectCategory(string componentType, DaprComponentCategory expected)
    {
        DaprComponentCategoryHelper.FromComponentType(componentType).ShouldBe(expected);
    }

    [Fact]
    public void FromComponentType_WithNull_ReturnsUnknown()
    {
        DaprComponentCategoryHelper.FromComponentType(null).ShouldBe(DaprComponentCategory.Unknown);
    }

    [Fact]
    public void FromComponentType_WithEmpty_ReturnsUnknown()
    {
        DaprComponentCategoryHelper.FromComponentType(string.Empty).ShouldBe(DaprComponentCategory.Unknown);
    }
    ...
    public void FromComponentType_WithUnknownPrefix_ReturnsUnknown(string componentType)
    {
        DaprComponentCategoryHelper.FromComponentType(componentType).ShouldBe(DaprComponentCategory.Unknown);
    }

    [Fact]
    public void FromComponentType_WithNoDotSeparator_ReturnsUnknown()
    {
        DaprComponentCategoryHelper.FromComponentType("stateonly").ShouldBe(DaprComponentCategory.Unknown);
    }

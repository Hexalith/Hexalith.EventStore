...
public class DaprSubscriptionInfoTests
{
    ...
    [InlineData("")]
    [InlineData("   ")]
    public void Constructor_WithInvalidPubSubName_ThrowsArgumentException(string? pubSubName)
    {
    ...
    [InlineData("")]
    [InlineData("   ")]
    public void Constructor_WithInvalidRoute_ThrowsArgumentException(string? route)
    {
        Should.Throw<ArgumentException>(() =>
            new DaprSubscriptionInfo("pubsub", "topic", route!, "DECLARATIVE", null));
    }
    ...
    [InlineData("")]
    [InlineData("   ")]
    public void Constructor_WithInvalidSubscriptionType_ThrowsArgumentException(string? subscriptionType)
    {
        Should.Throw<ArgumentException>(() =>

...
public class CausationChainTests {
    ...
    public void Constructor_WithValidInputs_CreatesInstance() {
        ...
        _ = chain.Events.ShouldHaveSingleItem();
        _ = chain.AffectedProjections.ShouldHaveSingleItem();
    }
    ...
    [InlineData("")]
    [InlineData("   ")]
    public void Constructor_WithInvalidOriginatingCommandType_ThrowsArgumentException(string? value) => Should.Throw<ArgumentException>(() =>
    ...
    [InlineData("")]
    [InlineData("   ")]
    public void Constructor_WithInvalidOriginatingCommandId_ThrowsArgumentException(string? value) => Should.Throw<ArgumentException>(() =>
    ...
    [InlineData("")]
    [InlineData("   ")]
    public void Constructor_WithInvalidCorrelationId_ThrowsArgumentException(string? value) => Should.Throw<ArgumentException>(() =>
                                                                                                        new CausationChain("CreateOrder", "cmd-001", value!, null, [], []));

    [Fact]
    public void Constructor_WithNullEvents_ThrowsArgumentNullException() => Should.Throw<ArgumentNullException>(() =>
                                                                                     new CausationChain("CreateOrder", "cmd-001", "corr-001", null, null!, []));

    [Fact]
    public void Constructor_WithNullAffectedProjections_ThrowsArgumentNullException() => Should.Throw<ArgumentNullException>(() =>
                                                                                                  new CausationChain("CreateOrder", "cmd-001", "corr-001", null, [], null!));

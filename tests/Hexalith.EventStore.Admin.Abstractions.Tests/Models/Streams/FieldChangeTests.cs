...
public class FieldChangeTests {
    ...
    [InlineData("")]
    [InlineData("   ")]
    public void Constructor_WithInvalidFieldPath_ThrowsArgumentException(string? fieldPath) => Should.Throw<ArgumentException>(() =>
                                                                                                        new FieldChange(fieldPath!, "\"old\"", "\"new\""));

    [Fact]
    public void Constructor_WithNullOldValue_ThrowsArgumentNullException() => Should.Throw<ArgumentNullException>(() =>
                                                                                       new FieldChange("$.status", null!, "\"new\""));

    [Fact]
    public void Constructor_WithNullNewValue_ThrowsArgumentNullException() => Should.Throw<ArgumentNullException>(() =>

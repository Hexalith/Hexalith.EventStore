...
public class SerializationRoundTripTests {
    ...
    public void StreamSummary_RoundTrips() {
        ...
        StreamSummary? deserialized = JsonSerializer.Deserialize<StreamSummary>(json, _options);
    ...
    public void AdminOperationResult_RoundTrips() {
        ...
        string json = JsonSerializer.Serialize(original, _options);
        AdminOperationResult? deserialized = JsonSerializer.Deserialize<AdminOperationResult>(json, _options);
    ...
    public void ProjectionStatus_RoundTrips() {
        ...
        string json = JsonSerializer.Serialize(original, _options);
        ProjectionStatus? deserialized = JsonSerializer.Deserialize<ProjectionStatus>(json, _options);
    ...
    public void EventTypeInfo_RoundTrips() {
        ...
        string json = JsonSerializer.Serialize(original, _options);
        EventTypeInfo? deserialized = JsonSerializer.Deserialize<EventTypeInfo>(json, _options);
    ...
    public void DaprComponentHealth_RoundTrips() {
        ...
        string json = JsonSerializer.Serialize(original, _options);
        DaprComponentHealth? deserialized = JsonSerializer.Deserialize<DaprComponentHealth>(json, _options);
    ...
    public void TenantSummary_RoundTrips() {
        ...
        string json = JsonSerializer.Serialize(original, _options);
        TenantSummary? deserialized = JsonSerializer.Deserialize<TenantSummary>(json, _options);
    ...
    public void DeadLetterEntry_RoundTrips() {
        ...
        string json = JsonSerializer.Serialize(original, _options);
        DeadLetterEntry? deserialized = JsonSerializer.Deserialize<DeadLetterEntry>(json, _options);
    ...
    public void SnapshotPolicy_RoundTrips() {
        ...
        string json = JsonSerializer.Serialize(original, _options);
        SnapshotPolicy? deserialized = JsonSerializer.Deserialize<SnapshotPolicy>(json, _options);
    ...
    public void FieldChange_RoundTrips() {
        ...
        string json = JsonSerializer.Serialize(original, _options);
        FieldChange? deserialized = JsonSerializer.Deserialize<FieldChange>(json, _options);
    ...
    public void PagedResult_RoundTrips() {
        ...
        string json = JsonSerializer.Serialize(original, _options);
        PagedResult<string>? deserialized = JsonSerializer.Deserialize<PagedResult<string>>(json, _options);

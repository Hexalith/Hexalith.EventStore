...
Read `/home/administrator/projects/hexalith/eventstore/.agents/skills/bmad-quick-dev/review-prompts/edge-case-hunter.md` completely and follow it as your review instructions.
...
Read `/home/administrator/projects/hexalith/eventstore/.agents/skills/bmad-quick-dev/review-prompts/verification-gap.md` completely and follow it as your review instructions.
...
4. Process findings in cascading order. If intent_gap or bad_spec findings exist, they trigger a loopback — lower findings are moot since code will be re-derived. If neither exists, process patch and defer normally. Before each loopback, read `{spec_file}` frontmatter `review_loop_iteration` (missing means `0`), increment it by 1, and write it back. If it exceeds 5, HALT and escalate to the human.
   ...
   - **defer** — Append one new entry to `/home/administrator/projects/hexalith/eventstore/_bmad-output/implementation-artifacts/deferred-work.md` using this format. Do not modify existing entries or look for duplicates.
     ```markdown
